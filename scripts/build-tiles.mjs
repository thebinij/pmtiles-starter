...
const builds = [
  ...
  },
  {
    ...
    args: [
      ...
      "-z12", "-Z3", "-S10",
      "--generate-ids",
      "--use-attribute-for-id=TARGET:provinces",
      "--use-attribute-for-id=DISTRICT:districts",
      "--use-attribute-for-id=locallevel_fullcode:locallevels",
      "--coalesce-densest-as-needed",
  ...
  },
  {
    ...
    args: [
      ...
      "-z10", "-Z1", "-S10",
      "--generate-ids",
      "--use-attribute-for-id=name:states",
  ...
  },
  {
    ...
    args: [
      ...
      "--layer=states",
      "--generate-ids",
      "--use-attribute-for-id=ID_1:states",
